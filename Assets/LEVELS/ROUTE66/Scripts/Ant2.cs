...
public class Ant2 : Destructible
{
    ...
    private void FUN_2B5C()
    {
        ...
        ((Body)pcVar2).state = _BODY_TYPE.Ant;
        sVar1 = (sbyte)GameManager.instance.FUN_1DD9C();
        ppcVar3.DAT_18 = sVar1;
        GameManager.instance.FUN_1E580(sVar1, ppcVar3.vData.sndList, 0, ppcVar3.vTransform.position);
    }

    //FUN_50F0 (ROUTE66.DLL)
    private static void FUN_50F0(ref Matrix3x3 param1, Vector3Int param2)
    {
        int iVar1;
        int iVar2;
        int iVar3;
