                ...
                if (-1 < iVar17)
                {
                    ...
                    do
                    {
                        ...
                        do
                        {
                            ...
                            iVar4 = (int)uVar11 - (iVar17 / 2 + 0x30);
                            ...
                            if ((int)uVar11 < 0x1000)
                            {
                                ...
                                uVar6 = (ushort)((ushort)(iVar3 >> 20) | (short)(iVar4 >> 9) * -0x800);
                            }
                            else
                                uVar6 = 0;

                            DAT_84_2[iVar13 / 2] = uVar6;
                            iVar3 = (int)(short)uVar6 - DAT_504[iVar13 / 2];
                            uVar11 = (uint)((iVar16 >> 16) - 12 + iVar12);

                            if (iVar3 != 0)
                            {
                                GameManager.instance.terrain.vertices[GameManager.instance.terrain.chunks[((uVar11 >> 6) * 4 + (uVar7 >> 6) * 128) / 4] * 4096 +
