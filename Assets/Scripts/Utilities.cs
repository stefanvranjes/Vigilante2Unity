...
public static class Utilities
{
    ...
    //gp+310h
    public static string[] DAT_310 =
    {
        "Wonderwagon", "Thunderbolt", "Dakota Stunt Cycle",
        "Samson Tow Truck", "Livingston Truck", "Xanadu RV",
        "Palomino XIII", "El Guerrero", "Blue Burro Bus",
        "Excelsior Stretch", "Tsunami", "Marathon",
        "Moon Trekker", "Grubb Dual Loader", "Chrono Stinger",
        "Vertigo", "Goliath Halftrack", "Wapiti 4WD"
    };
    ...
    public static KeyValuePair<string, Type>[][] levelTypes =
    {
        new KeyValuePair<string, Type>[]
        {
            ...
            new KeyValuePair<string, Type>("BridgeS", typeof(Bridge)), 
            new KeyValuePair<string, Type>("BridgeL", typeof(Bridge)), 
    ...
    public static Dictionary<Type, _SPECIAL_INIT> specialInits = new Dictionary<Type, _SPECIAL_INIT>()
    {
        ...
        { typeof(StarPower), StarPower.OnInitialize },
        { typeof(HellGate), HellGate.OnInitialize },
        { typeof(Bird), Bird.OnInitialize }
    };
    ...
    public static Dictionary<Type, _OBJECT_INIT> objectInits = new Dictionary<Type, _OBJECT_INIT>()
    {
        ...
        { typeof(TestThruster), TestThruster.OnInitialize },
        { typeof(GuardTower), GuardTower.OnInitialize },
        { typeof(TurbineShock), TurbineShock.OnInitialize },
        { typeof(ForkLift), ForkLift.OnInitialize },
        { typeof(CraneSmall), CraneSmall.OnInitialize }
    };
    ...
    public static int FUN_29E24(Vector3Int v3)
    {
        ...
        return (int)SquareRoot(iVar3 + iVar1 + iVar2);
    }
    ...
    {
        VigTransform t1;
        VigTransform local_88;
        VigTransform local_68;
        Vector3Int local_28;
        Vector3Int local_20;
        Vector3Int local_18;

        FUN_2A168(out local_28, v1[0], v1[1]);
        FUN_2A168(out local_18, v1[0], v1[2]);
        local_20 = FUN_2A1E0(local_18, local_28);
        local_20 = VectorNormal(local_20);
        local_18 = FUN_2A1E0(local_28, local_20);
        local_88 = new VigTransform();
        local_88.rotation.V00 = (short)local_28.x;
        local_88.rotation.V10 = (short)local_28.y;
        local_88.rotation.V20 = (short)local_28.z;
        local_88.rotation.V01 = (short)local_20.x;
        local_88.rotation.V11 = (short)local_20.y;
        local_88.rotation.V21 = (short)local_20.z;
        local_88.rotation.V02 = (short)local_18.x;
        local_88.rotation.V12 = (short)local_18.y;
        local_88.rotation.V22 = (short)local_18.z;
        local_88.position.x = v1[0].x;
        local_88.position.y = v1[0].y;
        local_88.position.z = v1[0].z;
        FUN_2A168(out local_28, v2[0], v2[1]);
        FUN_2A168(out local_18, v2[0], v2[2]);
        local_20 = FUN_2A1E0(local_18, local_28);
        local_20 = VectorNormal(local_20);
        local_18 = FUN_2A1E0(local_28, local_20);
        local_68 = new VigTransform();
        local_68.rotation.V00 = (short)local_28.x;
        local_68.rotation.V10 = (short)local_28.y;
        local_68.rotation.V20 = (short)local_28.z;
        local_68.rotation.V01 = (short)local_20.x;
        local_68.rotation.V11 = (short)local_20.y;
        local_68.rotation.V21 = (short)local_20.z;
        local_68.rotation.V02 = (short)local_18.x;
        local_68.rotation.V12 = (short)local_18.y;
        local_68.rotation.V22 = (short)local_18.z;
        local_68.position.x = v2[0].x;
        local_68.position.y = v2[0].y;
        local_68.position.z = v2[0].z;
        t1 = FUN_2A3EC(local_88);
        return CompMatrixLV(local_68, t1);
    }
    ...
    public static Vector3Int FUN_2A2E0(Matrix3x3 m33)
    {
        ...
        return new Vector3Int(sVar2, sVar1, sVar3);
    }
    ...
    public static void FUN_2A85C(ref Matrix3x3 m33, Vector3Int v1, Vector3Int v2)
    {
        ...
        local_18 = new Vector3Int(-v2.x, -v2.y, -v2.z);
        local_8 = new Vector3Int();
        ...
        Coprocessor.accumulator.ir2 = (short)local_8.y;
        Coprocessor.ExecuteOP(12, false);
        m33.V01 = (short)local_18.x;
        m33.V11 = (short)local_18.y;
        m33.V21 = (short)local_18.z;
        local_28 = new Vector3Int(
            Coprocessor.mathsAccumulator.mac1, 
            Coprocessor.mathsAccumulator.mac2, 
            Coprocessor.mathsAccumulator.mac3);
        local_28 = VectorNormal(local_28);
        Coprocessor.rotationMatrix.rt11 = (short)local_28.x;
        Coprocessor.rotationMatrix.rt12 = (short)(local_28.x >> 16);
        Coprocessor.rotationMatrix.rt22 = (short)local_28.y;
        Coprocessor.rotationMatrix.rt23 = (short)(local_28.y >> 16);
        Coprocessor.rotationMatrix.rt33 = (short)local_28.z;
        Coprocessor.accumulator.ir3 = (short)local_18.z;
        Coprocessor.accumulator.ir1 = (short)local_18.x;
        Coprocessor.accumulator.ir2 = (short)local_18.y;
        Coprocessor.ExecuteOP(12, false);
        m33.V00 = (short)local_28.x;
        m33.V10 = (short)local_28.y;
        m33.V20 = (short)local_28.z;
    ...
    public static void FUN_245AC(ref Matrix3x3 m33, Vector3Int sv)
    {
        ...
        m33._V21 = m33.V21;
        m33._V22 = m33.V22;
        m33.V00 = (short)(m33.V00 * iVar3 >> 12);
        m33.V01 = (short)(m33.V01 * iVar4 >> 12);
        m33.V02 = (short)(m33.V02 * iVar5 >> 12);
        m33.V10 = (short)(m33.V10 * iVar3 >> 12);
        m33.V11 = (short)(m33.V11 * iVar4 >> 12);
        m33.V12 = (short)(m33.V12 * iVar5 >> 12);
        m33.V20 = (short)(m33.V20 * iVar3 >> 12);
        m33.V21 = (short)(m33.V21 * iVar4 >> 12);
        m33.V22 = (short)(m33.V22 * iVar5 >> 12);
        m33.skewed = true;
    }
    ...
    public static void FUN_2449C(Matrix3x3 m33, Vector3Int v3, ref Matrix3x3 mout)
    {
        ...
        mout._V21 = mout.V21;
        mout._V22 = mout.V22;
        mout.V00 = (short)((int)((uint)m33.V00 * (uint)v3.x) >> 12);
        mout.V01 = (short)((int)((uint)m33.V01 * (uint)v3.y) >> 12);
        mout.V02 = (short)((int)((uint)m33.V02 * (uint)v3.z) >> 12);
        mout.V10 = (short)((int)((uint)m33.V10 * (uint)v3.x) >> 12);
        mout.V11 = (short)((int)((uint)m33.V11 * (uint)v3.y) >> 12);
        mout.V12 = (short)((int)((uint)m33.V12 * (uint)v3.z) >> 12);
        mout.V20 = (short)((int)((uint)m33.V20 * (uint)v3.x) >> 12);
        mout.V21 = (short)((int)((uint)m33.V21 * (uint)v3.y) >> 12);
        mout.V22 = (short)((int)((uint)m33.V22 * (uint)v3.z) >> 12);
        mout.skewed = true;
    }
    ...
    public static void FUN_2A454(VigTransform t1, VigTransform t2, out VigTransform t3)
    {
        ...
        t3.padding = 0; //not in the original code
    ...
    public static Vector3Int FUN_23ED0(VigTransform transform, Vector3Int v3)
    {
        ...
        Coprocessor.vector0.vz0 = (short)v3.z;
        Coprocessor.ExecuteMVMVA(_MVMVA_MULTIPLY_MATRIX.Rotation, _MVMVA_MULTIPLY_VECTOR.V0, _MVMVA_TRANSLATION_VECTOR.None, 12, false);
        iVar1 = transform.position.y;
        iVar2 = transform.position.z;
        iVar3 = Coprocessor.mathsAccumulator.mac1;
        iVar4 = Coprocessor.mathsAccumulator.mac2;
        iVar5 = Coprocessor.mathsAccumulator.mac3;
        return new Vector3Int(transform.position.x + iVar3, iVar1 + iVar4, iVar2 + iVar5);
    }

    public static void FUN_24BFC(int param1, Vector2Int param2, Vector2Int param3, 
        Vector3Int in_v0, Vector3Int in_v1, ref Primitive param4)
    {
        int iVar3;
        int iVar5;
        int iVar6;
        ...
        Coprocessor.vector0.vx0 = (short)(iVar3 + in_v1.x);
        Coprocessor.vector0.vy0 = (short)(iVar5 + in_v1.y);
        Coprocessor.vector0.vz0 = (short)(iVar6 + in_v1.z);
        Coprocessor.ExecuteRTPS(12, false);
        param4.screen = new Vector2Int(Coprocessor.screenXYFIFO.sx2, Coprocessor.screenXYFIFO.sy2); //sxyp
        ...
        Coprocessor.ExecuteGPF(12, false);
        Coprocessor.accumulator.ir0 = (short)(0x1000 - param1);
    ...
    public static int FUN_26B80(int param1, int param2, int param3, int param4, Primitive[] primitives)
    {
        ...
        local_18 = new Vector3Int(Coprocessor.vector0.vx0, Coprocessor.vector0.vy0, Coprocessor.vector0.vz0);
        local_10 = new Vector3Int(Coprocessor.vector1.vx1, Coprocessor.vector1.vy1, Coprocessor.vector1.vz1);
        local_8 = new Vector3Int(Coprocessor.vector2.vx2, Coprocessor.vector2.vy2, Coprocessor.vector2.vz2);
        ...
        if (param2 < 0)
        {
            if (param3 < 0)
            {
                if (-1 < param4)
                {
                    ...
                    iVar4 = (param4 << 12) / (param4 - param3);
                    FUN_24BFC((param4 << 12) / (param4 - param2), primitives[param1].uvs, primitives[param1 + 2].uvs,
                                local_18, local_8, ref primitives[param1]);
                    FUN_24BFC(iVar4, primitives[param1 + 1].uvs, primitives[param1 + 2].uvs, local_10, local_8, ref primitives[param1 + 1]);
                    iVar3 = 3;
                }
                else
                    iVar3 = 0;
            ...
            else
            {
                if (param4 < 0)
                {
                    ...
                    iVar4 = (param3 << 12) / (param3 - param4);
                    FUN_24BFC((param3 << 12) / (param3 - param2), primitives[param1].uvs, primitives[param1 + 1].uvs,
                        local_18, local_10, ref primitives[param1]);
                    FUN_24BFC(iVar4, primitives[param1 + 2].uvs, primitives[param1 + 1].uvs, local_8, local_10, ref primitives[param1 + 2]);
                    iVar3 = 3;
                }
                else
                {
                    ...
                    iVar4 = (param3 << 12) / (param3 - param2);
                    FUN_24BFC((param4 << 12) / (param4 - param2), primitives[param1].uvs, primitives[param1 + 2].uvs, 
                        local_18, local_8, ref primitives[param1 + 2]);
                    FUN_24BFC(iVar4, primitives[param1].uvs, primitives[param1 + 1].uvs, local_18, local_10, ref primitives[param1]);
                    iVar3 = 4;
                }
            }
        }
        else
        {
            if (param3 < 0)
            {
                if (param4 < 0)
                {
                    ...
                    iVar4 = (param2 << 12) / (param2 - param4);
                    FUN_24BFC((param2 << 12) / (param2 - param3), primitives[param1 + 1].uvs, primitives[param1].uvs, 
                        local_10, local_18, ref primitives[param1 + 1]);
                    FUN_24BFC(iVar4, primitives[param1 + 2].uvs, primitives[param1].uvs, local_8, local_18, ref primitives[param1 + 2]);
                    iVar3 = 3;
                }
                else
                {
                    ...
                    primitives[param1 + 2].screen = new Vector2Int(Coprocessor.screenXYFIFO.sx2, Coprocessor.screenXYFIFO.sy2);
                    primitives[param1 + 2].verts = new Vector3Int(Coprocessor.screenXYZFIFO.sx2, Coprocessor.screenXYZFIFO.sy2, Coprocessor.screenXYZFIFO.sz2);
                    iVar4 = (param2 << 12) / (param2 - param3);
                    FUN_24BFC((param4 << 12) / (param4 - param3), primitives[param1 + 1].uvs, primitives[param1 + 2].uvs, 
                        local_10, local_8, ref primitives[param1 + 3]);
                    FUN_24BFC(iVar4, primitives[param1 + 1].uvs, primitives[param1].uvs, local_10, local_18, ref primitives[param1 + 1]);
                    iVar3 = 4;
                }
            }
            else
            {
                if (param4 < 0)
                {
                    ...
                    primitives[param1 + 1].verts = new Vector3Int(Coprocessor.screenXYZFIFO.sx1, Coprocessor.screenXYZFIFO.sy1, Coprocessor.screenXYZFIFO.sz1);
                    iVar4 = (param2 << 12) / (param2 - param4);
                    FUN_24BFC((param3 << 12) / (param3 - param4), primitives[param1 + 2].uvs, primitives[param1 + 1].uvs, 
                        local_8, local_10, ref primitives[param1 + 3]);
                    FUN_24BFC(iVar4, primitives[param1 + 2].uvs, primitives[param1].uvs, local_8, local_18, ref primitives[param1 + 2]);
                    iVar3 = 4;
                }
                else
    ...
    public static long VectorNormal2(Vector3Int n1, out Vector3Int n2)
    {
        ...
        return MSC02_OBJ_100_2(new Vector3Int(normal_x, normal_y, normal_z), out n2);
    }
    ...
    public static long MSC02_OBJ_100_2(Vector3Int normal, out Vector3Int result)
    {
        ...
        result = new Vector3Int(mac1, mac2, mac3);
        return sum;
    }
...
{
    public VigObject vObject; //0x08
    public uint flag; //0x0C
...
{
    public short type; //0x08
    public short id; //0x0A
    public short[] array; //0x0C
