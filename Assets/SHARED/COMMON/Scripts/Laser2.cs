...
public class Laser2 : VigObject
{
    ...
    private static byte[] COLLDR = new byte[] { 0x01, 0x00, 0x00, 0x00, 0x93, 0xE6, 0xFF, 0xFF, 0x7F, 0xEB,
                                                  0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xA3, 0x6C, 0x00, 0x00,
                                                  0x82, 0x14, 0x00, 0x00, 0x81, 0x8B, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00 };
    ...
    public override uint OnCollision(HitDetection hit)
    {
        ...
        GameManager.instance.FUN_1E580(iVar3, vData.sndList, 5, vTransform.position);
        ...
        if (hit.self.type == 2)
        {
            ...
            UIManager.instance.FUN_4E414(hit.self.vTransform.position, new Color32(0x80, 0x00, 0x00, 8));
